...
python get_feature_seq_from_immuannot.py HLA-ClassII_seq.fa.gz immuannot_MHC-c2.out.gtf.gz
python get_feature_seq_from_immuannot.py KIR_all.fa.gz immuannot_KIR-all.out.gtf.gz
tar czvf HLA-C2-KIR_gene_feature_sequences_from_immuannot.tgz *_features.fa
